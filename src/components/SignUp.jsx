    ...
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <div className="w-full lg:w-1/2 bg-gradient-to-br from-[crimson] to-[#7E69AB] flex flex-col items-center justify-center p-6 lg:p-10 text-white">
        <div className="w-full max-w-md space-y-6 text-center lg:text-left">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">SavvyZi</h1>
          <p className="text-xl md:text-2xl text-white/90">
            Join our community of smart shoppers
          </p>
          <div className="mt-8 space-y-4">
            <p className="text-lg">✓ Get personalized price alerts</p>
            <p className="text-lg">✓ Save your favorite products</p>
            <p className="text-lg">✓ Earn rewards on every purchase</p>
          </div>
        </div>
      </div>

      {/* Right Section - Sign Up Form */}
      <div className="w-full lg:w-1/2 bg-white flex flex-col items-center justify-center p-6 lg:p-10 overflow-hidden">
