                ...
                <div className="flex space-x-4 sm:space-x-6">
                  ...
                  {Object.entries(groupedOffers).map(([subcategory, subcategoryOffers]) => {
                    ...
                    return (
                      ...
                      >
                        <div className="w-16 h-16 sm:w-20 sm:h-20 mb-2 overflow-hidden rounded-full hover:shadow-[0_0_3px_3px_rgba(177,156,217,0.5)] transition-shadow">
                          <img
                            src={imageUrl}
                            alt={subcategory}
                  ...
                  {groupedOffers.brandsWithoutSubcategory.map((brand) => (
                    ...
                    >
                      <div className="w-16 h-16 sm:w-20 sm:h-20 mb-2 overflow-hidden rounded-full hover:shadow-[rgba(177,156,217,0.5)] shadow-lg transition-shadow">
                        <img
                          src={brand["LOGO LINK"]}
                          alt={brand.COMPANY}
