  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8">
        <button
          onClick={handleBack}
          className="mb-4 text-black bg-gray-300 py-1 px-3 rounded-md hover:bg-gray-400 hover:text-black transition"
        >
            ...
            >
              ...
              <div className="space-y-2 text-center">
                {offer.action_ranges.map((action, index) => (
                  ...
                  >
                    ...
                    <span className="font-light ml-1">{formatRange(action)}</span>
                  </div>
                ))}
              </div>
              ...
              {offer.avg_money_transfer_time && (
                <p className="mt-2 text-xs text-gray-700">
                  Payout in <span className="font-medium">{offer.avg_money_transfer_time} days</span>
                </p>
              )}
              ...
              {offer.gotolink && (
                <button
                  className="mt-4 text-xs bg-[crimson] text-white py-1 px-3 rounded-md hover:bg-gray-400 hover:text-black transition"
          ...
          <DialogContent className="max-w-lg p-6">
            ...
            <div className="mt-6 space-y-6">
              <p className="text-sm text-gray-700 whitespace-pre-wrap">
                {cleanData(getTermsForOffer(currentOfferName))}
              </p>
