      ...
      <div className="relative">
        ...
        >
          {stores.map((store, index) => (
            <div
              key={store.COMPANY}
              className="flex-shrink-0 w-30 sm:w-30 md:w-40 flex flex-col items-center p-1 sm:p-2 bg-white rounded-lg shadow-md  hover:shadow-[0_0_3px_3px_rgba(177,156,217,0.5)] transition-shadow duration-300 hover:scale-105"
              style={{
