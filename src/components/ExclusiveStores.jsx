        ...
        >
          {stores.map((store, index) => (
            ...
            >
              ...
              <p className="text-fit text-gray-700 bg-gray-100 px-1 sm:px-2 py-0.5 sm:py-1 rounded-md flex justify-center items-center gap-0.5 sm:gap-1 w-full overflow-hidden">
