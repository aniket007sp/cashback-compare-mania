    ...
    <section className="w-full px-1 sm:px-2 py-2 sm:py-4">
      ...
      <div className="flex overflow-x-auto space-x-2 py-2">
        {stores.map((store) => (
          <div
            key={store.COMPANY}
            className="flex-shrink-0 w-20 sm:w-30 md:w-40 flex flex-col items-center p-1 sm:p-2 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow cursor-pointer"
