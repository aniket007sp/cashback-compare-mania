    ...
    <aside className="w-full h-full bg-white shadow-md p-1">
      ...
      <div className="grid grid-cols-1 gap-1 sm:gap-2">
        {brands.map((brand, index) => (
          ...
          >
            {hoveredIndex === index ? (
              <div className="flex flex-col items-center p-2 sm:p-3 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow cursor-pointer w-[90%] sm:w-full mx-auto h-28 sm:h-36">
              ...
              <div className="flex flex-col items-center p-2 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow cursor-pointer w-[90%] sm:w-full mx-auto h-24 sm:h-28">
                <img
                  src={brand.logo}
                  alt={`${brand.name} logo`}
