    ...
    <footer className="bg-gray-800 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* About Us Section */}
          <div>
            <h3 className="text-md sm:text-md md:text-lg lg:text-xl font-semibold mb-4">About Us</h3>
          ...
          {/* Links Section */}
          <div>
            <h3 className="text-md sm:text-md md:text-lg lg:text-xl font-semibold mb-4">Connect with Us</h3>
            <ul className="space-y-4">
              <li>
                <a 
                  ...
                  className="flex items-center text-sm sm:text-sm md:text-md text-gray-400 hover:text-white"
                >
                  <img
              ...
              <li>
                <a href="https://forms.gle/yWa4vtRBjhNzpdfL7" target="_blank" rel="noopener noreferrer" className="flex items-center text-gray-400 text-sm sm:text-sm md:text-md hover:text-white" >
                Feedback Form
                </a>
              </li>
            </ul>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 flex flex-col text-sm sm:text-sm md:text-m sm:flex-row justify-between items-center">
